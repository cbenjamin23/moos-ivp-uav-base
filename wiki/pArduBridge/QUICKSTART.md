...
uXMS alpha.moos \
  ...
  UAV_LANDING_TARGET_AVAILABLE UAV_LANDING_TARGET_AGE \
  UAV_LANDING_TARGET_COMPONENT_ID UAV_LANDING_TARGET_POSITION_VALID \
  UAV_LANDING_TARGET_DISTANCE UAV_LANDING_TARGET_X \
  UAV_LANDING_TARGET_Y UAV_LANDING_TARGET_Z \
