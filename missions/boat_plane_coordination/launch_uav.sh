...
LAT_ORIGIN=59.428096
LON_ORIGIN=10.467345
...
nsplug uav.moos targ_uav.moos $NSFLAGS WARP=$TIME_WARP \
...
nsplug uav.bhv targ_uav.bhv $NSFLAGS VNAME=$VNAME \
...
#-------------------------------------------------------
echo "Launching uav MOOS Community. WARP="$TIME_WARP
pAntler targ_uav.moos >& /dev/null &
echo "Done Launching uav MOOS Community"
