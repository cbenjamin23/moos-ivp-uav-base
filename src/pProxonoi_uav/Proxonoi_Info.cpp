...
void showExampleConfigAndExit()
{
  ...
  blk("  vehicle_stale_treshold = 10 // Default: 10 s                  ");
  blk("                                                                ");
  ...
  blk("                                                                ");
  blk("  // If true, loitering contacts are excluded from Voronoi      ");
  blk("  // and ownship Voronoi output is suppressed while loitering.  ");
  blk("  exclude_loitering_contacts = false // Default: false          ");
  blk("                                                                ");
  blk("  // If true, returning contacts are excluded from Voronoi      ");
  blk("  // and ownship Voronoi output is suppressed while returning.  ");
  blk("  exclude_returning_contacts = false // Default: false          ");
  blk("                                                                ");
  blk("  // Vehicle name to always ignore (repeat line as needed).     ");
  blk("  always_ignore_name = vehicle_x // Default: (empty)            ");
  blk("}                                                               ");
  blk("                                                                ");
  exit(0);
}
...
void showInterfaceAndExit()
{
  ...
  blk("                SPD=2.0,HDG=118.8,YAW=118.8,DEPTH=4.6,          ");
  blk("                LENGTH=3.8,MODE=MODE@BHV_MODE:LOITER           ");
  blk("    // Reports from other vehicles or contacts. MODE is used    ");
  blk("    // for loiter exclusion if configured.                      ");
  blk("                                                                ");
  blk("  NAV_X = 123.45                                                ");
  ...
  blk("                                                                ");
  blk("  MODE / BHV_MODE / AUTOPILOT_MODE                              ");
  blk("    // Ownship mode subscriptions used for loiter detection.    ");
  blk("                                                                ");
