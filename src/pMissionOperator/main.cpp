...
int main(int argc, char *argv[])
{
  ...
  cout << "pMissionOperator launching as " << run_command << endl;
  cout << termColor() << endl;
  ...
  std::string save_path = std::string(home_dir) + "/moos-ivp-uav/missions/pMissionOperator.log";
  Logger::configure(save_path);

  MissionOperator search_grid;
