...
void showSynopsis()
{
  blk("SYNOPSIS:                                                       ");
  blk("------------------------------------                            ");
  blk("  The pOdometry application computes planar odometry by         ");
  blk("  integrating distance traveled from NAV_X and NAV_Y.           ");
  blk("                                                                ");
  blk("  Gated (paired) position updates are used to avoid             ");
  blk("  double-counting when NAV_X and NAV_Y arrive                   ");
  blk("  asynchronously.                                               ");
  blk("                                                                ");
  blk("  The total distance traveled is published as                   ");
  blk("  ODOMETRY_DIST and can be reset via the                        ");
  blk("  ODOMETRY_RESET command.                                       ");
}
