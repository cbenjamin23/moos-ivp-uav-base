...
public:
    ...
    MTSP(GA_CONF _conf, Dinic &dinic, vector<int> &_depot, int _cmw, bool _coverAndReturn) : conf(_conf), depot(_depot), cmw(_cmw), coverAndReturn(_coverAndReturn)
    {
        ...
        // Only use the brick's corner and midpoints for mapping.
