...
int main(int argc, char *argv[])
{
  ...
  cout << "pGridSearchPlanner launching as " << run_command << endl;
  cout << termColor() << endl;
  ...
  std::string save_path = std::string(home_dir) + "/moos-ivp-uav/missions/pGridSearchPlanner.log";
  Logger::configure(save_path);

  GridSearchPlanner search_grid;
